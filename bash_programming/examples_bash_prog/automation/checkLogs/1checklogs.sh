...
arrayLogsRedHat=(messages secure boot.log dmesg kern.log faillog cron yum.log mail.log httpd mysql.log all_errors_classified)
...
{
	echo -e '\E[32m'"List of Red Hat system logs: $tecreset"
	echo ""
	for i in {0..11}
	do
...
then
	...
	do
		...
		q)
			...
			;;
		*)
			echo -e '\e[31;22m'"Wrong option, please select a value from 0-11 or q to quit: $tecreset"
			;;
		esac
	done

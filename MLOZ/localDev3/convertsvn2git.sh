...
# Version 1.1
# Rationale: Convert SVN repos onto Git repos in order to migrate source control Dev projects
# 
# Example: http://svn.gfdi.be/svn/FOA/trunk/big_leap_project/wcm_ws_modules
# For SVN the project is: big_leap_project
# For migration purposes the project is the folder: wcm_ws_modules 
# This is actually built via Jenkins job, not the whole SVN project big_leap_project
# 
# File Structure:
# 
# Execution Directory: (Git repo will be created in another directory) 
# 	convertsvn2git.sh
#	cloneStatus.sh (This scripts checks repos listed in CSV files, and returns status on whether have been cloned onto Git repo already)
#	svn-migration-scripts.jar
#	/authors
#   /logs
#	/svn-repos-csv (Directory which contains all SVN csv repo files)
# 
# To be modified: Git Root Directory, e.g.: /home/israel/git/svn-repos (If doesn't exist, script will create it)
#

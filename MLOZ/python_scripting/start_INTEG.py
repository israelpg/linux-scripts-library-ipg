...
# First CLIENTS_998, then JADER, then all Clusters + individual servers
...
if CLIENTS_998_status != '': # CLIENTS_998 started ... Starting JadeR:
    starting(JADER_200a[0], JADER_200a[1])
    starting(JADER_500b[0], JADER_500b[1])
